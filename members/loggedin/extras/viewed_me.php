 ...
 */
?>
<div class="heading-submenu dsp-block" style="display:none"><strong><?php echo language_code('DSP_MENU_VIEWED_ME'); ?></strong></div>
<?php
// ----------------------------------------------- Start Paging code------------------------------------------------------ //  
if (get('page'))
    $page = get('page');
    ...
    <div class="box-border">
        <div class="box-pedding">  
            <div class="page-not-found">
                <?php echo language_code('DSP_NO_ONE_VIEW_YOUR_PROFILE'); ?><br /><br />
            </div>
        </div>
    </div>
    <?php
