<?php
/**
* This files is used to send ajax response for io viewed me members
*/
...
if( ! empty( $search_members ) ) :
	...
	printf( __( '<div class="lm-members-not-found">%1$s<span class="lm-pagenot-found-pagetitle">%2$s</span>%3$s</div>', 'love-match' ), 'No More','Viewers', 'Available' );
endif;