...
?>
<div class="heading-submenu dsp-block" style="display:none"><?php echo language_code('DSP_MENU_TRENDING') ?></div>
        ...
        <div class="content-search dsp-gutter-sm">
            <form action="<?php echo $root_link . "extras/trending/"; ?>" method="post" class="dspdp-form-inline dspdp-text-center">
                <div class="row" align="center">
                    <div class="dsp-md-5 dsp-control-label">
                        ...
                        ?>
                            ...
                            ?>
                            <select  class="dspdp-form-control" name="gender_filter" onchange="this.form.submit();" style="margin-left:20px">
                                <?php echo get_gender_list($gender); ?>    
                            </select>
                            <?php
                        }
                            ...
                            <div class="box-search-result  image-container">
                                <div class="dsp-user-info-container halfforth clearfix dsp-block" style="display:none;">
                                    ...
                                    <span class="online dspdp-online-status dsp-block dsp-selected" style="display:none">
                                        <span class=" <?php echo $online ?>" ' . language_code('DSP_CHAT_ONLINE') . '></span>
                                    </span>
                                </div>
        ...
        <div class="box-border">
            <div class="box-pedding">
                <div class="page-not-found">
                    <?php echo language_code('DSP_NO_RESULT_FOUND'); ?><br /><br />
                </div>
            </div>
        </div>
<?php endif; ?>
