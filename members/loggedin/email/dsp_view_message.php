...
<div class="box-border">
    <div class="box-pedding">
        <div class="dsp_back_inbox dspdp-spacer"><a class=" dspdp-btn dspdp-btn-default dspdp-btn-xs" href="<?php echo $root_link . "email/inbox/"; ?>"><?php echo language_code('DSP_BACK_TO_INBOX'); ?></a></div>
        <?php
        //+++++++++++++++++++++++++++++++++++++++++++++++++++++++
        if (get('page'))
            $page = get('page');
            ...
            <div class="dspdp-bordered-item-md"><div class="view-message dspdp-row dsp-row">
                ...
                <div class="dspdp-col-sm-9 dsp-sm-9"> <div class="msg-info">
                        <div>
                            ...
                            <div class="dspdp-spacer dsp-spacer"><?php echo str_replace('\\', '', $message->text_message); ?></div>
                            <?php if ($message->sender_id != $user_id) { ?>
                                <div><a class="btn-reply dspdp-btn dspdp-btn-default dspdp-btn-xs" href="<?php echo $root_link . "email/compose/msgid/" . $message->message_id . "/sender_ID/" . $message->sender_id . "/Act/Reply/"; ?>"><?php echo language_code('DSP_MESSAGE_REPLY'); ?></a></div>
                            <?php } //end if   ?>
                        </div>
                    </div>
                </div>
