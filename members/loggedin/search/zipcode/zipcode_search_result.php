                            ...
                            <ul class="user-links">
                                ...
                                <li class="dspdp-col-xs-3">
                                    <div class="dsp_fav_link_border">
                                        ...
                                        if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
                                            ?>
                                            <a href="<?php echo $root_link . "add_favorites/user_id/" . $user_id . "/fav_userid/" . $s_user_id . "/"; ?>" title="<?php echo language_code('DSP_ADD_TO_FAVOURITES'); ?>"><img src="<?php echo $fav_icon_image_path ?>star.jpg" border="0" alt="Star" /></a>
                                        <?php } else { ?>
