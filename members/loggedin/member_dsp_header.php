...
<div class="dsp-tab-container dspdp-tab-container"> 
    <div class="dsp-line">
        <div <?php if (($pageurl == "1") || ($pageurl == "")) { ?>class="dsp_tab1-active" <?php } else { ?>class="dsp_tab1" <?php } ?>>
            <?php
                if (is_user_logged_in()) {  // CHECK MEMBER LOGIN
            ?>
                <a href="<?php echo $root_link . "home/mypage/"; ?>" title="<?php echo language_code('DSP_MENU_MY_PAGE') ?>"><?php echo language_code('DSP_MENU_MY_PAGE') ?></a></div>
            <?php } else { ?>
                <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><?php echo language_code('DSP_MENU_MY_PAGE') ?></a></div>
            <?php } ?>
        <?php if ($check_free_email_access_mode->setting_status == 'Y'):?>    
            ...
            <?php } else { ?>
                <a href="<?php echo wp_login_url(get_permalink()); ?>" title="Login"><?php echo language_code('DSP_MIDDLE_TAB_MESSAGE') ?></a></div>
            <?php } ?>
         <?php endif; ?>
