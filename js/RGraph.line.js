...
RGraph.Line = function(id)
{
    ...
    this.properties = {
        ...
        'chart.numyticks': 10,
        'chart.linewidth': 4,
        'chart.colors': ['#18bdc3', '#0f0', '#00f', '#f0f', '#ff0', '#0ff'],
        'chart.hmargin': 0,
        'chart.tickmarks.dot.color': 'white',
        'chart.tickmarks': 'filledendsquare',
        ...
        'chart.yaxispoints': 5,
        'chart.fillstyle': true,
        'chart.xaxispos': 'bottom',
        'chart.yaxispos': 'left',
        'chart.xticks': null,
        'chart.text.size': 10,
        'chart.text.angle': 0,
        'chart.text.color': '#e4f3f8',
        'chart.fill.color': 'black',
...
RGraph.Line.prototype.DrawLabels = function()
{
    ...
    this.context.fillStyle = this.properties['chart.fill.color'];
    this.context.lineWidth = 1;
