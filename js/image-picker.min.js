    ...
    jQuery.fn.extend({imagepicker: function(e) {
        ...
        return t.prototype.build_and_append_picker = function() {
            ...
            for (this.picker = jQuery("<ul class='thumbnails image_picker_selector'></ul>"), this.picker_options = function() {
                var i, s, l, n;
                for (l = this.select.find("option"), n = [], i = 0, s = l.length; s > i; i++)
                    t = l[i], n.push(new e(t, this, this.opts));
                return n
            }.call(this), l = this.picker_options, i = 0, s = l.length; s > i; i++)
                t = l[i], t.has_image() && this.picker.append(t.node);
            return this.picker
