        ...
        <div class="dsp-row">
            ...
            if ($total_results1 > 0) {
                ...
                <form name="delblockedmembersfrm" action="" method="post">
                    <div class="title-text"><strong><?php echo language_code('DSP_BLOCKED_MEMBERS') ?></strong></div>
                    <?php
                    ...
                    foreach ($blocked_members as $Member) {
                        ...
                        <div class="dsp-sm-3"><div class="image-container">
                            ...
                            if ($check_couples_mode->setting_status == 'Y') {
                                ...
                                <?php } ?>
                            <?php } ?>
                            <span style="float:left; width:100%;" onclick="delete_blocked_member(<?php echo $blocked_id ?>);" class="dsp_span_pointer"><?php echo language_code('DSP_UNBLOCK_LINK') ?></span> 
                        </div></div>
                        <?php
                        $i++;
                        unset($favt_mem);
