...
if ($profile_pageurl == "account_settings") {
    ...
    include(WP_DSP_ABSPATH . "/m/user_account_settings.php");
}

if ($profile_pageurl == "match_alert") {

    include(WP_DSP_ABSPATH . "/m/match_alert_settings.php");
} else if ($profile_pageurl == "notification") {

    include(WP_DSP_ABSPATH . "/m/user_notification_settings.php");
} else if ($profile_pageurl == "privacy_settings") {

    include(WP_DSP_ABSPATH . "/m/user_privacy_settings.php");
} else if ($profile_pageurl == "upgrade_account") {


    include(WP_DSP_ABSPATH . "/m/upgrade_account_settings.php");
} else if ($profile_pageurl == "upgrade_account_details") {

    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_account_details.php");
} else if ($profile_pageurl == "dsp_paypal") {

    include(WP_DSP_ABSPATH . "/m/payments/paypal.php");
} else if ($profile_pageurl == "skype_settings") {

    include(WP_DSP_ABSPATH . "/m/dsp_skype_settings.php");
} else if ($profile_pageurl == "auth_settings") {

    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_setting_details.php");
} else if ($profile_pageurl == "auth_settings_detail") {

    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_check_setting.php");
} else if ($profile_pageurl == "pro_settings") {

    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_paypalpro_setting.php");
} else if ($profile_pageurl == "pro_settings_detail") {


    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_paypalpro_detail.php");
} else if ($profile_pageurl == "dsp_error") {

    include(WP_DSP_ABSPATH . "/m/dsp_error.php");
} else if ($profile_pageurl == "dsp_cancel") {

    include(WP_DSP_ABSPATH . "/m/dsp_cancel.php");
} else if ($profile_pageurl == "paypal_advance") {

    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_paypal_advance.php");
} else if ($profile_pageurl == "create_recur") {


    include(WP_DSP_ABSPATH . "/m/dsp_create_recur.php");
} else if ($profile_pageurl == "dsp_cancel_membership") {
    include(WP_DSP_ABSPATH . "/m/dsp_cancel_membership.php");
} else if ($profile_pageurl == "dsp_thank_you") {

    include(WP_DSP_ABSPATH . "/m/dsp_thank_you.php");
} else if ($profile_pageurl == "dsp_iDEAL_thank_you") {

    include(WP_DSP_ABSPATH . "/m/dsp_iDEAL_thank_you.php");
} else if ($profile_pageurl == "iDEAL") {

    include(WP_DSP_ABSPATH . "/m/dsp_upgrade_iDEAL_payment.php");
} else if ($profile_pageurl == "blocked") {

    include(WP_DSP_ABSPATH . "/m/dsp_blocked_members.php");
} else if ($profile_pageurl == "setting") {

    include(WP_DSP_ABSPATH . "/m/dspSettings.php");
}
?>