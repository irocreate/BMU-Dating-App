...
//$my_messages= $wpdb->get_results("SELECT * FROM $dsp_user_emails_table where sender_id=$user_id Order by thread_id desc");
			...
			<img src='" . get_bloginfo('url') . "/wp-content/plugins/dsp_dating/m/images/cc.png" . "'/>
                        ...
                        <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                            <div style="float:left; margin-top:20px;"><input type="checkbox" name="delmessage[]" value="<?php echo $message->message_id ?>" /></div>
                            <div class="image">
                                <div style="width: 100%">
                                    ...
                                    if ($check_couples_mode->setting_status == 'Y') {
                                            ...
                                            <?php if ($exist_make_private->make_private == 'Y') { ?>
                                                ...
                                                <?php if (!in_array($user_id, $favt_mem)) { ?>
                                                    ...
                                                    <a onclick ="viewProfile('<?php echo $message->receiver_id ?>', 'my_profile')">
                                                        ...
                                                        <img src="<?php echo $imagepath ?>/plugins/dsp_dating/images/private-photo-pic.jpg" style="width:75px; height:75px;" class="dsp_img2" align="left" />
                                                ...
                                                <?php } else {
                                                    ...
                                                    <a onclick ="viewProfile('<?php echo $message->receiver_id ?>', 'my_profile')">				
                                                        ...
                                                        <img src="<?php echo display_members_photo($message->receiver_id, $imagepath); ?>"   style="width:75px; height:75px;" class="dsp_img2" align="left"/></a>                
                                        ...
                                        <?php if ($exist_make_private->make_private == 'Y') { ?>
                                            ...
                                            <a onclick ="viewProfile('<?php echo $message->receiver_id ?>', 'my_profile')">
                                                ...
                                                <img src="<?php echo display_members_photo($message->receiver_id, $imagepath); ?>" style="width:75px; height:75px;" class="dsp_img2" align="left" />
                                            </a>
                            ...
                            <div class="msg-info">
                                <ul>
                                    <li class="name"><?php echo $display_sender_name->display_name; ?></li>
...
// -------------------------------- END OF PRINT PAGING LINKS ------------------------------------- // 
                    ...
                    <div class="btn-row" style="padding-top: 10px;float: left;">
                        ...
                        <?php if ($my_messages) { ?>
                        <input onclick="getSent('true', 0)" type="button" name="delmsg" value="<?php echo language_code('DSP_DELETE_SELECTED') ?>" />
                    <?php
                            } else {
