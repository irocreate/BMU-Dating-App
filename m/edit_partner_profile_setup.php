                ...
                <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                    ...
                    <ul class="edit-profile">
                        ...
                        <li class="row"><span><?php echo language_code('DSP_ABOUT_ME') ?></span>
                            ...
                            <textarea name="txtaboutme" id="txtaboutme" style="width:57%; height:50px;"><?php if ($check_partner_profile_exist != 0) echo $exist_profile_details->about_me; ?></textarea>
                        ...
                        foreach ($myrows2 as $profile_questions2) {
                            ...
                            <li class="row"><span><?php echo $profile_ques; ?></span>
                                ...
                                if ($profile_ques_type_id == 2) {
                                    ...
                                    <textarea name="option_id1[<?php echo $ques_id ?>]" id="text_option_id<?php echo $ques_id ?>" maxlength="<?php echo $profile_ques_max_length; ?>" style="width:57%; height:50px;"><?php echo $text_value ?></textarea>
                                <?php } ?>
                        ...
                        <li class="row"><span><?php echo language_code('DSP_MY_INTEREST'); ?></span>
                            ...
                            <textarea name="my_interest" style="width:57%; height:50px;"><?php echo $exist_profile_details->my_interest ?></textarea>
                        </li>
                    ...
                    <div>
                        ...
                        <input type="button" onclick="editPartnerQuestion('true', '<?php echo language_code('DSP_USER_NAME_SHOULD_NO_BE_EMPTY'); ?>')" name="submit"  value="<?php _e(language_code('DSP_UPDATE_BUTTON')); ?>" />
                    ...
                    <ul style="list-style: none;padding-left: 0px;">
                        <li style="height: 115px;"> 
                            <div style="float: left; padding-right: 5px; width: 40%;" id="profilePicture">
                                <img src="<?php echo display_members_partner_photo($user_partner_profile_id, $imagepath); ?>" style="width:100px; height:100px;"  class="img" />
                            ...
                            <div>
                                ...
                                <div>
                                    <button onclick="getPartnerPhoto(); return false;"><?php echo language_code('DSP_UPLOAD_PHOTOS') ?></button>
                                </div>
                            </div>
