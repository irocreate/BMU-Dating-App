...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    <div class="back-image" onclick="<?php echo ($page>1)?$function1 :$function2;?>">
        <a href="#"  ><?php echo language_code('DSP_BACK');?></a>
    </div>
...
if ($lastpage > 1) {
    ...
    if ($page > 1) {
        $pagination.="
				...
				<div onclick='saveHidden(1)' class='btn-pre1' style=' border-bottom-left-radius: 10px;border-top-left-radius: 10px;'>
					<img src='" . get_bloginfo('url') . "/wp-content/plugins/dsp_dating/m/images/bb.png" . "'/>
				</div>";
    } else {
        $pagination.= "
				<div class='btn-pre1' style=' border-bottom-left-radius: 10px;border-top-left-radius: 10px;'>
