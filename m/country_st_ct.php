...
countrySel.onchange = function() {
	...
	var get_state_city_url = "<?php echo plugins_url('dsp_dating/m/get_state_city.php'); ?>?country=" + selectedCountry;
	make_request(get_state_city_url, state_change);

	var get_city_url = "<?php echo plugins_url('dsp_dating/m/get_city.php'); ?>?state=0&country=" + selectedCountry;
...
document.getElementById("state_change").addEventListener( 'change', function(e) {
	...
	if( targ.id == "cmbState_id" ) {
		...
		var get_ct_url = "<?php echo plugins_url('dsp_dating/m/get_city.php'); ?>?state=" + selectedState + "&country=" + selectedStateCountry;
