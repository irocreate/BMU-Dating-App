...
<div role="banner" class="ui-header ui-bar-a" data-role="header">
    ...
    <a data-icon="check" onclick="goBlank()" class="ui-btn-right ui-btn ui-btn-up-a ui-shadow ui-btn-corner-all" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" data-theme="a">
...
$a = $pluginpath . "/m/post_one.php?sender_id=" . $user_id . "&receiver_id=" . $_REQUEST['mem_id'];

$b = $pluginpath . "/m/log_tab_one.php?sender_id=" . $user_id . "&receiver_id=" . $_REQUEST['mem_id'];
                                                    ...
                                                    if ($check_free_trail_mode->setting_status == "N") {
                                                        ...
                                                        if ($check_membership_msg == "Expired") {
                                                            ...
                                                            <div>
                                                                ...
                                                                <div >
                                                                    <div id="onechatbox1">
                                                                        <?php include(WP_DSP_ABSPATH . '/m/log_tab_one.php'); ?>
                                                                    </div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <form id="frmchat">
                                                                            ...
                                                                            <input type="text" style="width:60%" value="" name="usermsg" id="usermsg1" maxlength="75"/>
                                                                            <!--<input style="width:60%" name="usermsg" type="text" id="usermsg1"  maxlength="75" value=""  />-->
                                                                            <input name="submitmsg" type="button"  value="Send" onclick="callOneChat('<?php echo $_REQUEST['receiver_id'] ?>', 'post', 'val')"/>
                                                                        </form>
