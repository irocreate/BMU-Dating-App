                    ...
                    if ($gateway->gateway_name == 'paypal' && $gateway->status == 1) {
                        ...
                        if ($clientID != "" && $clientSecret != "" && $apiUsername != "" && $apiPassword != "" && $apiSignature != "" && $business != "" && $currency_code != "") {
                            ...
                            <div style="padding-bottom: 10px;">
                                <form id="frm_paypal" name="frm_paypal" >
                                    ...
                                    <input id="paypalBtn" onclick="getCredit()" name="upgrade_credit" title="Upgrade / PayPal" type="button" value="<?php echo language_code('DSP_PAYPAL') ?>"  style="text-decoration:none;" />
                                    <br />  
                        ...
                        <div style="padding-bottom: 10px;">
                            <form id="frm_auth">
                                ...
                                <input type="hidden" class="no_of_credit_to_purchase" name="no_of_credit_to_purchase" value="1" />
                                <input onclick="callUpgrade('credit_auth_setting', '0')"  id="paypalBtn" name="upgrade" title="Upgrade / Credit Card" type="button" value="<?php echo language_code('DSP_CREDIT_CARD') ?>" class="dsp_span_pointer" style="text-decoration:none; margin-top:5px;" />
                            </form>
                        ...
                        <div style="padding-bottom: 10px;">
                            <form id="frm_pro" name="frm_pro" >
                                <input onclick="callUpgrade('credit_pro_settings', '0')" id="paypalBtn" name="upgrade" title="Upgrade / PayPal Pro" type="button" value="<?php echo language_code('DSP_PAYPAL_PRO') ?>" />
                                <input type="hidden" name="credit_amount" class="credit_amount" value="<?php echo $credit_row->price_per_credit; ?>" /> 
                                <input type="hidden"  name="user_id" value="<?php echo $user_id; ?>" />
