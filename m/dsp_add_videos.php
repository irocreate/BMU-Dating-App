...
<?php if (isset($delete_video_msg) && $delete_video_msg != "") { ?>
    ...
    <div class="thanks">
        ...
        <p align="center" class="error"><?php echo $delete_video_msg ?></p>
                ...
                <div style=" width:80%; float:left;">
                    <div>
                        <div style="width: 100%;padding-bottom: 5px;">
                            <?php echo language_code('DSP_ADD_VIDEO'); ?><span style="font-weight: bold; font-size: 10px;"> Formats - .3GP, .MP4</span>
                        </div>
                        <div><button onclick="uploadVideo();"><?php echo language_code('DSP_UPLOAD_BUTTON') ?></button></div>

                        <div><?php echo language_code('DSP_MAKE_PRIVATE'); ?>
                            <input name="private" type="checkbox" value="Y" onclick="savePrivate(this.value)"/> </div>
