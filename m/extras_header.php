...
if ($extra_pageurl == "viewed_me") {
    ...
    if ($check_free_mode->setting_status == "N") {  // free mode is off 
        if ($check_force_profile_mode->setting_status == "Y") {  // if force profile mode is OFF
            ...
            if ($check_force_profile_msg == "Approved") {
                ...
                include(WP_DSP_ABSPATH . "/m/viewed_me.php");
    ...
    if ($check_free_mode->setting_status == "N") {  // free mode is off 
        if ($check_force_profile_mode->setting_status == "Y") {  // if force profile mode is OFF
            ...
            if ($check_force_profile_msg == "Approved") {
                ...
                include(WP_DSP_ABSPATH . "/m/iviewed.php");
            } else if ($check_force_profile_msg == "NoAccess") {
                include(WP_DSP_ABSPATH . "/m/dsp_print_message.php");
            } else if ($check_force_profile_msg == "Expired") {
                include(WP_DSP_ABSPATH . "/m/dsp_print_message.php");
    ...
    if ($check_free_mode->setting_status == "N") {  // free mode is off 
        if ($check_force_profile_mode->setting_status == "Y") {  // if force profile mode is OFF
            ...
            if ($check_force_profile_msg == "Approved") {
                ...
                include(WP_DSP_ABSPATH . "/m/trending.php");
            } else if ($check_force_profile_msg == "NoAccess") {
                include(WP_DSP_ABSPATH . "/m/dsp_print_message.php");
            } else if ($check_force_profile_msg == "Expired") {
                include(WP_DSP_ABSPATH . "/m/dsp_print_message.php");
    ...
    if ($check_free_mode->setting_status == "N") {  // free mode is off 
        if ($check_force_profile_mode->setting_status == "Y") {  // if force profile mode is OFF
            ...
            if ($check_force_profile_msg == "Approved") {
                ...
                include(WP_DSP_ABSPATH . "/m/interest_cloud.php");
            } else if ($check_force_profile_msg == "NoAccess") {
                include(WP_DSP_ABSPATH . "/m/dsp_print_message.php");
            } else if ($check_force_profile_msg == "Expired") {
                include(WP_DSP_ABSPATH . "/m/dsp_print_message.php");
    ...
    include(WP_DSP_ABSPATH . "/m/date_tracker.php");
} else if ($extra_pageurl == "edit_date_tracker") {
    include(WP_DSP_ABSPATH . "/m/edit_date_tracker.php");
} else if ($extra_pageurl == "meet_me") {
    include(WP_DSP_ABSPATH . "/m/dsp_meet_me.php");
} else if ($extra_pageurl == "blogs") {

    include(WP_DSP_ABSPATH . "/m/myblogs_header.php");
} else {
    include(WP_DSP_ABSPATH . "/m/iviewed.php");
}
?>