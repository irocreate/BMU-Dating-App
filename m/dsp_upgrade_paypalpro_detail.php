...
$membership_plan_amount = isset($_REQUEST['payment_amuont']) ? $_REQUEST['payment_amuont'] : '';
...
//echo "INSERT INTO $dsp_temp_payments_table SET user_id = '$user_id',plan_id = '$membership_plan_id',plan_amount ='$membership_plan_amount',plan_days='$plan_days',plan_name='$membership_plan',payment_date='$payment_date',start_date='$payment_date',expiration_date=DATE_ADD('$payment_date', INTERVAL $plan_days DAY),payment_status=0";
...
//echo 'user=='.$check_already_user_exists;
...
$firstName = urlencode($_REQUEST['customer_first_name']);
$lastName = urlencode($_REQUEST['customer_last_name']);
...
$address1 = urlencode($_REQUEST['customer_address1']);
$address2 = urlencode($_REQUEST['customer_address2']);
$city = urlencode($_REQUEST['customer_city']);
$state = urlencode($_REQUEST['customer_state']);
$zip = urlencode($_REQUEST['customer_zip']);
...
if ("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
    ...
    $reason = "Sorry! Your Transaction has failed.";
