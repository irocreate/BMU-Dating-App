...
// ###########################  Reject Friend request  ########################################
    ...
    if ($count_friends_request > 0) {
        ...
        <div class="swipe_div" id="mainFriendReq" style="height: 122px">
...
//$frnd_request_members=$wpdb->get_results("SELECT * FROM $dsp_my_friends_table  where friend_uid='$user_id' AND approved_status='N' LIMIT 20");
                ...
                foreach ($frnd_request_members as $request_mem) {
                    ...
                    <li class="ivew-list">
                        ...
                        <?php } ?>
                        <div class="dsp_name">
                            <span onclick="showAlertPage('alert', 'approve', '<?php echo $request_mem->friend_id ?>')" class="dsp_span_pointer reply-btn" style="margin-top: -2px;"><?php echo language_code('DSP_MEDIA_LINK_APPROVE') ?></span><span onclick="showAlertPage('alert', 'reject', '<?php echo $request_mem->friend_id ?>')" class="dsp_span_pointer delete-btn" style="margin-top: -4px;" ><?php echo language_code('DSP_MEDIA_LINK_REJECT') ?></span>
                        </div>
                    </li>
                    <?php
                    $i++;
