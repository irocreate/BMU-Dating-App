...
if ($profile_pageurl == "upgrade_account") {
    ...
    include(WP_DSP_ABSPATH . "/m/dsp_credit_upgrade_setting_details.php");
} else if ($profile_pageurl == "credit_auth_settings_detail") {
    include(WP_DSP_ABSPATH . "/m/dsp_credit_upgrade_check_setting.php");
} else if ($profile_pageurl == "credit_pro_settings") {
    include(WP_DSP_ABSPATH . "/m/dsp_credit_upgrade_paypalpro_setting.php");
} else if ($profile_pageurl == "credit_pro_settings_detail") {

    include(WP_DSP_ABSPATH . "/m/dsp_credit_upgrade_paypalpro_detail.php");
}
?>