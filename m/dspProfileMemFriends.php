                            ...
                            <div class="profile_img_view">
                                ...
                                <?php if ($user_id == '') {
                                    ...
                                    <a onclick="viewProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">
                                        <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>" class="dsp_img3" style="width:100px; height:100px;" alt="<?php echo $displayed_member_name; ?>"/></a>
                                        ...
                                        if ($member_friends->gender == 'C') {
                                            ...
                                            if ($member_friends->make_private == 'Y') {
                                                ...
                                                <a onclick="viewProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')"> 
                                                    ...
                                                    <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>" class="dsp_img3" style="width:100px; height:100px;" alt="<?php echo $displayed_member_name; ?>" />
                                            ...
                                            if ($member_friends->make_private == 'Y') {
                                                ...
                                                if (!in_array($user_id, $favt_mem)) {
                                                    ...
                                                    <a onclick="viewProfile('<?php echo $member_friends->friend_uid; ?>', 'my_profile')">				
                                                        ...
                                                        <img src="<?php echo display_members_photo($member_friends->friend_uid, $imagepath); ?>"    class="dsp_img3" width="100" height="100" alt="<?php echo $displayed_member_name; ?>" />
                                                    </a>                
