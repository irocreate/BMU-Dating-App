...
<span> <br />
    <div class="delete-btn" onclick="updateWink(<?php echo $wink_msg_id ?>, '<?php echo language_code('DSP_ARE_YOU_SURE_TO_DELETE_IT') ?>');" ><?php echo language_code('DSP_DELETE_LINK'); ?>
</span>
