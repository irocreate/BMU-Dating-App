                            ...
                            if ($audio_list_status == 0) {
                                ...
                                <td align="left" class="thumbnails-bg">
                                    <table cellpadding="0" border="0">
                                        ...
                                        <tr>
                                            <td><span onclick="approve_audio('<?php echo $audio_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo language_code('DSP_MEDIA_LINK_APPROVE') ?></span>|</td>
                                            <td><span onclick="reject_audio('<?php echo $audio_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo language_code('DSP_MEDIA_LINK_REJECT') ?></span>|</td>
                                            <td><span onclick="delete_audio('<?php echo $audio_file_id ?>')" class="span_pointer" style="font-size:12px;"><?php echo language_code('DSP_DELETE'); ?></span></td></tr>
                                    </table>
                                </td>
                                <?php
