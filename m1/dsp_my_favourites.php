                            ...
                            <div class="dsp_pro_full_view">
                                ...
                                <div class="dsp_on_lf_view">
                                          ...
                                          <div class="user-name spacer-bottom-xs spacer-top-sm"> <?php echo $displayed_member_name; ?></div>
                                            ...
                                            <span class="button-delete" onclick="myFavorite('<?php echo $favourite_id ?>', '<?php echo language_code('DSP_DELETE_EMAIL_MESSAGE') ?>');" title="<?php echo language_code('DSP_DELETE_LINK') ?>"><?php echo language_code('DSP_DELETE_LINK') ?></span>
