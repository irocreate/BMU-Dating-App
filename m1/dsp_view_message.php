                ...
                <li data-corners="false" data-shadow="false" class="ui-body ui-body-d ui-corner-all">
                    ...
                    <div class="dsp_mail_full">
                        ...
                        <?php if ($message->sender_id != $user_id) {
                            ?>
                            <a  class="button-edit spacer-bottom-xs" onclick="composeMessage('<?php echo $message->sender_id ?>', '<?php echo $message->message_id; ?>')" ><?php echo language_code('DSP_MESSAGE_REPLY'); ?></a>
                        <?php } //end if    ?>
                    </div>
                </li>
