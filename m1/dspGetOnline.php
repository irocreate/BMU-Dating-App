...
<div data-role="content" class="ui-content" role="main" >
    ...
    <div>
        <div class="col-cont clearfix">
            <div class="col-2">
              <label data-role="fieldcontain" class="select-group">  
                  <div  class="mam_reg_lf select-label"><?php echo language_code('DSP_AGE') ?></div>
        ...
        <div class="col-2">
            <label class="select-group">
             ...
             <div  class="mam_reg_lf select-label">      
                <?php echo language_code('DSP_TO') ?></div>
    ...
    <div class="btn-blue-wrap">
        <input name="submit" onclick="getOnlinePage(0)" id="login_filter" class="mam_btn btn-blue" type="button" value="<?php echo language_code('DSP_FILTER_BUTTON') ?>" />
    </div>
</fieldset>
</form>
