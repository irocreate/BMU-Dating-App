    ...
    <div class="content-primary">	
     <div style="padding-bottom: 20px;">
                <a onclick="callPhoto('album', 0)">
                    <img src="images/icons/gallery@3x.png" class="img3" /> <strong><?php echo language_code('DSP_BACK_TO_ALBUMS') ?></strong>
                </a>
                ...
                <li data-corners="false" data-shadow="false"  data-wrapperels="div" class="ui-body ui-body-d ui-corner-all" style="text-align: center;">
                    ...
                    <div  style="width: 100%;padding-top: 15px;">
                        <form id="frmManagePhoto_<?php echo $i; ?>">
                            ...
                            <span onclick="callPhoto('deleteAlbumPic', 'frmManagePhoto_<?php echo $i; ?>');" class="button-delete spacer-bottom-xs spacer-top-xs"><?php echo language_code('DSP_DELETE'); ?></span>
                        </form>
                    </div>
                </li>
