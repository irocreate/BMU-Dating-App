...
class CI_Input {
    ...
    function _sanitize_globals() {
        ...
        $protected = array('_SERVER', '_GET', '_POST', '_FILES', '_REQUEST', '_SESSION',
            ...
            'system_folder', 'application_folder', 'BM', 'EXT', 'CFG', 'URI', 'RTR',
            'OUT', 'IN');
    ...
    function xss_clean($str, $is_image = FALSE) {
         ...
         *
         */
        $words = array('javascript', 'expression', 'vbscript', 'script', 'applet',
        ...
        foreach ($words as $word) {
            ...
            $str = preg_replace_callback('#(' . substr($temp, 0, -3) . ')(\W)#is', array(
                $this, '_compact_exploded_words'), $str);
        }
        /*
        ...
        do {
            ...
            if (preg_match("/<a/i", $str)) {
                $str = preg_replace_callback("#<a\s+([^>]*?)(>|$)#si", array($this,
                    '_js_link_removal'), $str);
            }
            if (preg_match("/<img/i", $str)) {
                $str = preg_replace_callback("#<img\s+([^>]*?)(\s?/?>|$)#si", array(
                    $this, '_js_img_removal'), $str);
            }
        ...
        $str = preg_replace_callback('#<(/*\s*)(' . $naughty . ')([^><]*)([><]*)#is', array(
            $this, '_sanitize_naughty_html'), $str);
        /*
