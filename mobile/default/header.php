...
<body >
        ...
        <div id="wptouch-login">
            <div id="wptouch-login-inner">
                <form name="loginform" id="loginform" action="<?php bloginfo('wpurl'); ?>/wp-login.php" method="post">
                    ...
                    <a href="javascript:return false;"><img class="head-close" src="<?php echo compat_get_plugin_url('dsp_dating'); ?>/mobile/core/core-images/head-close.png" alt="close" /></a>
                </form>
            </div>
        </div>
    <?php } ?>
                            ...
                            <?php if (is_user_logged_in()) { ?>
                                ...
                                <li><a href="<?php
                                    ...
                                    if ($version >= 2.7) {
                                        ...
                                        bloginfo('wpurl');
                                        ?>/wp-login.php?action=logout&redirect_to=<?php echo $_SERVER['REQUEST_URI']; ?><?php } ?>"><?php _e("Logout", "wptouch"); ?></a></li>
                                <?php } ?>
                            <?php } ?>
                    </ul>
                <?php } ?>
    ...
    <div id="headerbar">
        <div id="headerbar-title">
            ...
            <!--<img id="logo-icon" src="<?php echo bnc_get_title_image(); ?>" alt="<?php
