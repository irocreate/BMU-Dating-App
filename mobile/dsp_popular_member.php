...
<script type="text/javascript">
    function getPopMemPage(pageNo, root_link)
    {
        //alert('ih');
        if (pageNo == "")
        {
            document.getElementById("popMem").innerHTML = "";
            //alert(pageNo);
            return;
        }
        ...
        xmlhttp.onreadystatechange = function()
        {
            ...
            if (xmlhttp.readyState == 4 && xmlhttp.status == 200)
            {
                ...
                document.getElementById("popMem").innerHTML = xmlhttp.responseText;

            }
        }


        var url = "<?php echo get_bloginfo('url') . '/wp-content/plugins/dsp_dating/mobile/dsp_pop_mem_pagi.php' ?>";
...
$totalQuery = "SELECT receiver_id,count(wink_id)as wink FROM $dsp_member_winks_table 
							join $dsp_user_profiles where receiver_id=user_id $gender_check 
                                                            ...
                                                            <?php } else { ?>
                                                                ...
                                                                <?php } else { ?> 
                                                                    ...
                                                                    echo add_query_arg(array(
                                                                        ...
                                                                        'pagetitle' => "view_profile"), $root_link);
                                                                    ?>">
                                                                        <img src="<?php echo display_members_photo($pop_member_id, $image_path); ?>"   class="dsp_img3" style="width:55px; height:55px;"/></a>
                                                                <?php } ?>
